...
function Page() {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (!session) { navigate({ to: "/etudiant/connexion" }); return; }
  ...
  return (
    <PageShell title="Dashboard Étudiant">
      <div className="card-glass rounded-2xl p-8">
        ...
        <p className="text-muted-foreground">Bienvenue dans votre espace étudiant. Consultez vos notes, annonces, emploi du temps et événements.</p>
      </div>
    </PageShell>
  );
}
