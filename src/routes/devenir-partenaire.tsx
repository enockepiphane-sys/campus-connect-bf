...
export const Route = createFileRoute("/devenir-partenaire")({
  head: () => ({ meta: [{ title: "Devenir partenaire — CampusLink" }] }),
  component: Page,
});
    ...
    <PageShell title="Devenir partenaire">
      <div className="card-glass rounded-2xl p-8">
        <div className="mb-6 text-center">
          ...
          <p className="text-sm text-muted-foreground">Votre établissement souhaite rejoindre CampusLink ? Envoyez-nous une demande, notre équipe vous recontactera.</p>
        </div>
...
function Field({ icon, label, name, type = "text", required }: { icon: React.ReactNode; label: string; name: string; type?: string; required?: boolean }) {
  return (
    <div>
