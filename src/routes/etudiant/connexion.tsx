...
function Page() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    if (!result.ok) { setError(result.error || "Accès non autorisé"); setBusy(false); return; }
      ...
      <div className="card-glass mx-auto max-w-md rounded-2xl p-8">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="text-right">
            <a href="/mot-de-passe-oublie" className="text-sm text-primary hover:underline">Mot de passe oublié ?</a>
          </div>
