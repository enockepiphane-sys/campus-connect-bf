    ...
    <PageShell title="Dashboard Administrateur">
      <div className="card-glass rounded-2xl p-8">
          ...
          <div>
            ...
            {etabNom && (
              <p className="mt-1 flex items-center gap-2 text-sm text-primary">
                <Building2 className="h-4 w-4" /> {etabNom}
              </p>
            )}
          </div>
        ...
        <p className="text-muted-foreground">
          Bienvenue dans votre espace administrateur. Gérez les filières, niveaux, matières,
          notes, annonces, événements et emplois du temps de votre établissement.
        </p>
      </div>
    </PageShell>
  );
